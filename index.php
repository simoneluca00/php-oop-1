...
class Movie {
    ...
    // 2) impostazione del costruttore
    ...
    // 3) funzione che stabilisce il prezzo per il noleggio
...
// 7) stampa dei valori per "È stata la mano di Dio"
echo "<p>" . 
